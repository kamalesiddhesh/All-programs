...
public class ThreadGroup_Method_Demo3 {
	...
	public static void main(String[] args) throws InterruptedException{
		...
		System.out.println("activeCount : "+pg.activeCount()); //2
		System.out.println("activeGroupCount : "+pg.activeGroupCount());//1
		
		pg.list();
		
		Thread.sleep(10000);
		System.out.println("----------------------------------------------");
		System.out.println("activeCount : "+pg.activeCount());
		System.out.println("activeGroupCount : "+pg.activeGroupCount());
